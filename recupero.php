...
/* ==========================================
   ...
   ========================================== */
// Attiviamo la visualizzazione degli errori per capire se qualcosa non va
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Se il database non è connesso, fermiamo tutto
    if (!$db) {
        ...
        $result = @pg_query_params($db, $sql, array($input)); // La @ nasconde errori tecnici brutti

        if ($result && pg_num_rows($result) > 0) {
            $user = pg_fetch_assoc($result);
            
            // Trovato! Salviamo i dati e andiamo avanti
...
<body>
    ...
    <header>
        <nav class="navbar">
            <div style="flex:1;"></div> <div class="nav-center" style="flex:0;">
